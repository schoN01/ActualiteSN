  <div class="col-md-4">
        ...
        <input type="text" name="searchtitle" class="form-control" placeholder="Recherche..." required>
...
<?php } ?>
          ...
          <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">Actualités recentes</h5>
            <div class="card-body">
                      <ul class="mb-0">
<?php
...
?>
  ...
  <li>
   ...
   <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">Actualites populaires</h5>
            <div class="card-body">
                      <ul >
<?php
