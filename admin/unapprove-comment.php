...
if($_GET['action']=='del' && $_GET['rid'])
{
	...
	$delmsg="Commentaire supprimé définitivement";
}
...
<html lang="fr">
    <head>
        ...
        <title> | Gerer les categories</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Gérer les commentaires non approuvés</h4>
