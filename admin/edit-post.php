...
if($query)
{
$msg="Publication mis à jour avec succès";
}
else{
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Modifier une publication </h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Details d'une publication</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Publier une image</b></h4>
<img src="postimages/<?php echo htmlentities($row['PostImage']);?>" width="300"/>
<br />
<a href="change-image.php?pid=<?php echo htmlentities($row['postid']);?>">Mettre à jour une image</a>
</div>
</div>
</div>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Mise à jour </button>
