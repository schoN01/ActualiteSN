...
if($query)
{
$msg="Publication restaurée avec succès ";
}
else{
...
if($_GET['presid'])
{
    ...
    $delmsg="Publication supprimée définitivement";
}
...
<html lang="fr">
    <head>
        ...
        <!-- App title -->
        <title>Actualite Senegal | Gerer les publications</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Corbeille </h4>
...
<td colspan="4" align="center"><h3 style="color:red">Aucun Enregistrement</h3></td>
<tr>
<?php 
} else {
