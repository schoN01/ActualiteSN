...
if($query)
{
$msg="Publication de la Caractéristique de l'image actualisée ";
}
else{
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Mettre à jour l'image </h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        ...
                                        <li>
                                           ...
                                           <li>
                                            <a href="#"> Modifier les publications </a>
                                        </li>
                                        <li class="active">
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Image de la publication actuelle</b></h4>
