...
if($_GET['action']=='perdel' && $_GET['scid'])
{
	...
	$delmsg="Categorie supprimée definitivement";
}
...
<html lang="fr">
    <head>
        ...
        <title> Actualite | Gérer les sous-categories</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Gérér les sous categories</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Administrateur</a>
                                        </li>
                                        <li>
                                            <a href="#">Sous categorie </a>
                                        </li>
                                        <li class="active">
                                           Gérér les sous categories
                                        </li>
                                    </ol>
...
<strong>Oups!</strong> <?php echo htmlentities($delmsg);?></div>
<?php } ?>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Date de publication</th>
                                                                  <th>Date de dernières mis à jour</th>
                                                                <th>Action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
...
<td colspan="7" align="center"><h3 style="color:red">Aucun enregistrement</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Corbeille</h4>
   ...
   <table class="table m-0 table-colored-bordered table-bordered-danger">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Date de publication</th>
                                                                  <th>Date dernières mises à jour</th>
                                                                <th>Action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
