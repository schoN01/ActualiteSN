...
<html lang="fr">
    <head>
        ...
        <!-- App title -->
        <title>Actualite Senegal | Qui sommes-nous?</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Qui sommes-nous?  </h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Mettre à jour et publier</button>
