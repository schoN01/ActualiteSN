...
if($query)
{
echo "<script>alert('Détails de l'éditeur mis à jour.');</script>";
}
else{
...
<html lang="fr">
    <head>
        ...
        <title>ActualiteSenegal |Modifier les editeurs</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Modifier un éditeur</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Modifier un éditeur </b></h4>
                                    <hr />
...
?>
            ...
            <input type="text" class="form-control" value="<?php echo htmlentities($row['AdminEmailId']);?>" name="emailid" required>
             ...
             <div class="form-group">
            <label class="col-md-2 control-label">Creation de données</label>
            <div class="col-md-10">
            <input type="text" class="form-control" value="<?php echo htmlentities($row['CreationDate']);?>" name="cdate" readonly>
             ...
             <div class="form-group">
            <label class="col-md-2 control-label">Date de mise à jour</label>
            <div class="col-md-10">
