...
echo "<script>alert('Details de l'editeur supprimés.');</script>";
...
<html lang="fr">
    <head>
        ...
        <title> | Gérer les editeurs</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Gérer les éditeurs</h4>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Date de publication</th>
                                                                  <th>Date de dernier mises à jour</th>
                                                                <th>Action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
